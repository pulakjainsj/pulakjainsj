      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 space-y-4">
            <p className="text-muted-foreground leading-relaxed">Hi, I'm Pulak Jain, an aspiring graphic designer with a strong passion for creating visually appealing and impactful designs. I'm proficient in Canva, CorelDRAW, Adobe Photoshop and Figma, with hands-on experience designing flyers, social media graphics, and branding materials. I also have a keen interest in photography and photo editing, enhancing my designs with high-quality images.</p>
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="rounded-lg overflow-hidden shadow-lg aspect-square w-full max-w-md">
              <img
                ...
                alt="Pulak Jain - Professional Graphic Designer specializing in Canva, Figma, Photoshop and CorelDRAW"
