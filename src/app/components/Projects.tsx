...
const projects = [
  ...
  },
  {
    ...
    description: 'Made this Instagram post for The Daily Grind coffee shop promotion. Wanted those warm brown tones to give it that cozy coffee vibe. They were running a first purchase discount, so kept the design simple enough that the offer stands out but still looks inviting.',
          ...
          {projects.map((project) => {
            ...
            <Card key={project.id} className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardHeader className="pt-6 pb-6">
                <CardDescription className={`text-left leading-relaxed text-sm ${isExpanded ? '' : 'line-clamp-2'}`}>{project.description}</CardDescription>
