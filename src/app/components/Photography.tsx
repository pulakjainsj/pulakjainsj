      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Collection of photography work including landscape, portrait, street, and nature photography showcasing creative composition and photo editing skills.
          </p>
        </div>
          ...
          <Masonry gutter="16px">
            {photographyImages.map((image) => (
              ...
              >
                <ImageWithFallback
                  src={image.url}
                  alt={`${image.category} photography by Pulak Jain - professional photo editing and composition`}
